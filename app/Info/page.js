 ...
 return (
    <div className={styles.all}>
     <div className='p-10 md:p-30 pb-95  '>
                <div className='mb-10'>
                    <h2  className=' relative z-10 xl:pl-30 pt-35 text-white xl:text-4xl text-3xl text-shadow-lg '>Hi, I’M SHAIMA <span className="multiple-text"></span></h2>
    ...
    <SpotlightCard className=" w-50 xl:ml-30 mt-25 box-content size-30  content-center  cursor-pointer text-center 
    h-6 text-white [transition:0.5s] rounded-3xl p-1 absolute custom-spotlight-card">
